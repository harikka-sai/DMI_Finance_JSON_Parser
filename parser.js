...
const url = 'mongodb+srv://yerramsettyharikka:uzVJN70ATWOrmpcn@cluster0.cchw4r1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
async function storeInMongoDB(data, dbName, res) {
    try {
        ...
        if (matchingCollection) {
            ...
            newCollectionName = `dynamic_collection_${Date.now()}`.replace(/[.$]/g, '');
